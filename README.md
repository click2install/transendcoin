...
Shell script to install an [Transend Masternode](https://bitcointalk.org/index.php?topic=3066505.0) on a Linux server running Ubuntu 16.04.
...
TRANSEND: TCdbhETKoDd1eaFiFV6a6HrUob5s6vnVYN
...
You are now ready to configure your local wallet and finish the masternode setup
 ...
 1. Make sure you have downloaded the latest wallet from https://github.com/TScoin/Transend/releases
